...
const ContactCard: FC = () => {
  return (
    <div className='border-3 border-main-orange rounded-3rxl bg-black bg-opacity-80 w-full min-w-1/2 flex-auto h-full flex flex-col'>
      ...
      <div className='flex flex-col p-8 lg:p-12 lg:pe-60 lg:py-24 h-full w-full  justify-evenly lg:justify-between'>
        {data.map((item, index) => {
          return (
            <div className='flex flex-col w-full lg:gap-8 gap-y-4' key={index}>
