    ...
    <div
      ...
      <div className='px-32 flex flex-col justify-around  bg-gradient-to-r from-black to-transparent from-52% h-full'>
        <div className='flex flex-col gap-8 max-w-1/2'>
          ...
          <p className='lg:text-3xl md:text-2xl 2xl:text-4xl max-h-40  2xl:max-h-80 overflow-y-scroll [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]'>
            {description}
          </p>
        </div>
