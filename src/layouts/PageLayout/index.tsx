...
<<<<<<< HEAD
      <div
        className={`${className}  px-12 lg:px-60 min-w-[15px] pl-[15px] pr-[15px] pt-[3dvh] flex flex-col gap-16 h-full w-full`}>
=======
<<<<<<< HEAD
<<<<<<< HEAD
<<<<<<< HEAD
...
<<<<<<< HEAD
>>>>>>> 11a804c ([feat] fixed paddings in news)
=======
=======
...
>>>>>>> 40f08b1 ([feat] re-fixed news displaying)
        {title && (
          <p
