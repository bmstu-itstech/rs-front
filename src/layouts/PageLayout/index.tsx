...
export const PageLayout: FC<Props> = ({
    ...
    return (
      ...
      ${
                ...
                hasOrangeShadow &&
                'lg:after:absolute after:-z-10 after:top-0 after:w-full after:left-0 after:h-full after:bg-linear-to-t after:from-main-orange-50 after:to-60% after:to-transparent '
            ...
            <div
                className={`${className ? className : ''} px-12 md:px-28 lg:px-20 xl:px-60 pt-[3dvh] flex flex-col gap-16 h-full w-full mx-auto max-w-800`}>
                {title && (
                    <p
