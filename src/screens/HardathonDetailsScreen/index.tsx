    ...
    return (
        <div className="!pt-[30px] mb-[100px] min-h-[100vh] flex flex-col gap-[50px] max-sm:!pb-[30px]">
            ...
            <div className="relative flex max-lg:flex-col gap-[30px] md:gap-[80px] justify-center items-stretch max-sm:mx-auto max-sm:w-[100vw]">
              <div className={`absolute top-[-120px] max-lg:hidden`} style={{ left: "calc(18vw - (100vw - 1920px) * 0.1)" }}>
              ...
              <div className="!px-[30px] !py-[50px] rounded-[60px] border-[3px] border-[var(--primary-color)] bg-black/55 flex flex-col justify-between max-md:gap-[30px] max-md:text-center">
                <div className="text-[16px] md:text-[32px]">Дата проведения: xx.xx.20xx</div>
                <div className="text-[16px] md:text-[32px]">Старт приёма заявок: xx.xx.20xx</div>
                <div className="text-[16px] md:text-[32px]">Окончание регистрации: xx.xx.20xx</div>
                <div className="text-[16px] md:text-[32px]">Подведение итогов: xx.xx.20xx</div>
