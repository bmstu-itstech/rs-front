      ...
      <div className='flex flex-col  h-full justify-center lg:justify-between items-center w-full '>
        <h1 className='w-fit  flex flex-col text-center'>
          <span
            ...
            className='animate-text-coloring text-white lg:text-9rxl text-5rxl md:text-8xl leading-[1.5] '>
            Центр
          </span>
          ...
          <span
            ...
            className=' text-logo-orange animate-text-coloring-highlighted  lg:text-9rxl text-5rxl md:text-8xl leading-[1.5]'>
            робототехники
          </span>
        </h1>
